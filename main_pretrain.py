...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='gcmae_vit_base_patch16', type=str, metavar='MODEL',
    ...
    # Npid parameters
    parser.add_argument('--low_dim', default=768, type=int, help='Low dimension')
    parser.add_argument('--nce_k', default=8192, type=int, help='NCE k')
    parser.add_argument('--nce_t', default=0.07, type=float, help='NCE t')
    parser.add_argument('--nce_m', default=0.5, type=float, help='NCE m')
...
def main(args):
    ...
    ndata = dataset_train.__len__()

    lemniscate = NCEAverage(args.low_dim, ndata, args.nce_k, args.nce_t, args.nce_m)
    criterion = NCECriterion(ndata)

    model = models_gcmae.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, lemniscate=lemniscate, criterion=criterion, args= args)
